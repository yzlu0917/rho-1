...
class Trainer:
    ...
    def init_model_and_tokenizer(self):
        ...
        model, tokenizer, config = init_slm_from_pretrained(
            pretrained_dir=self.model_args.pretrained_dir,
            k_percent=self.training_args.k_percent,
        )
    ...
    def build_dataloader(self):
        train_dataset = PretrainDataset(self.training_args.data_path, 
                                                self.training_args.anneal_path, 
                                                self.training_args.model_max_length)
        
        eval_dataset = PretrainDataset(self.training_args.eval_path, self.training_args.model_max_length)
